...
export default class AnnimationComponent extends Component  {
    constructor(props) {
        ...
        this.state = {text : this.props.text, lormPos : new Map([
            ...
            ["s", {animFade: new Animated.Value(0), anim1: new Animated.Value(0), animType: this.circleElement, xStart:.50, yStart: .70, xEnd: .50, yEnd: .70 }],
        ])};
    ...
    componentDidMount() {
        this.setState({lormPos : new Map([
            ...
            ["c", { animFade: new Animated.Value(0), anim1: new Animated.ValueXY({ x: this.getCoordonateX(.55), y: this.getCoordonateY(.90) }), animType: this.staticElement }],
            ["ç", { animFade: new Animated.Value(0), anim1: new Animated.ValueXY({ x: this.getCoordonateX(.50), y: this.getCoordonateY(.90) }), anim2: new Animated.ValueXY({ x: this.getCoordonateX(.55), y: this.getCoordonateY(.90) }), animType: this.staticElement }],
